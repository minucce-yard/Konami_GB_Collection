...
SET PATCH_FILE="Konami GB Collection Vol.1 (Europe) [Gradius - autoboot hack].ips"
...
armips -strequ ROM_FILE %ROM_FILE% -definelabel BUILD_LEVEL 1 -definelabel AUTOBOOT_GAME 0 %ASM_FILE%
rgbfix -fgh %ROM_FILE%
