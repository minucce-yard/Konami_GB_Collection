...
SET PATCH_FILE="Konami GB Collection Vol.1 (Europe) [Castlevania - The Adventure - autoboot hack + alternate border].ips"
...
armips -strequ ROM_FILE %ROM_FILE% -definelabel BUILD_LEVEL 1 -definelabel AUTOBOOT_GAME 1 -definelabel ALTERNATE_BORDER 1 %ASM_FILE%
rgbfix -fgh %ROM_FILE%
